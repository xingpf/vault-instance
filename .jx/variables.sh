...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-charts/vault-instance/master/3'
...
export MINK_IMAGE='ghcr.io/jenkins-x/vault-instance:1.0.25'
